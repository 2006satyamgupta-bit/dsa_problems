...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/delete-node-in-doubly-linked-list/1)

## Solved On
06 Sept 2026 at 04:41 pm

<h2><a href="https://www.geeksforgeeks.org/problems/delete-node-in-doubly-linked-list/1">Delete in a Doubly Linked List</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 18.6667px;">Given the <strong>head </strong>of a doubly<strong> </strong>linked list and an integer <strong>x</strong>, delete the node at the xth position (1-based indexing) and return the head of the modified list.</span></p>
...
<p><span style="font-size: 14pt;"><strong>Constraints:</strong><br>1 ≤ x ≤ size of the linked list ≤ 10<sup>6</sup><br>0 ≤ node-&gt;data ≤ 10<sup>4</sup></span></p>