...
## Solved On
05 Sept 2026 at 07:46 pm

<h2><a href="https://www.geeksforgeeks.org/problems/insert-a-node-in-doubly-linked-list/1">Insertion in a Doubly Linked List</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 14pt;">Given the <strong>head</strong> of a doubly-linked list, a position <strong>p,</strong> and an integer <strong>x.</strong> Insert a new node with value x at the position just after p<span style="font-size: 12pt;">th</span> node&nbsp;</span><span style="font-size: 18.6667px;">(0-based indexing)</span><span style="font-size: 14pt;"> in the doubly linked list and return the head of the modified list.</span></p>
